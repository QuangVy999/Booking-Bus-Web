    ...
    <div className="min-h-screen bg-slate-50 text-slate-800 font-sans pb-16">
      ...
      <div className="bg-gradient-to-r from-orange-600 to-amber-500 text-white shadow-md">
        ...
        <div className="max-w-6xl mx-auto px-4 py-8 text-center space-y-2 relative">
          ...
          <p className="text-sm text-orange-100 font-semibold">Thứ 2, 27/07 - Thứ 5, 30/07</p>
        </div>
      </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                {/* Right: Terms & Notes */}
                <div className="space-y-4 text-[11px] text-slate-500 leading-relaxed border-l border-slate-100 pl-0 md:pl-6">
                  <h4 className="font-bold text-orange-600 uppercase tracking-wider">Điều khoản & Lưu ý</h4>
                  <p className="font-semibold text-rose-600">Quý khách vui lòng Đăng ký/Đăng nhập tài khoản để nhận chương trình khuyến mãi.</p>
                  <p>(*) Quý khách vui lòng có mặt tại bến xuất phát của xe trước ít nhất 30 phút giờ xe khởi hành, mang theo thông báo đã thanh toán vé thành công chứa mã vé gửi từ hệ thống.</p>
                  <p>(*) Nếu quý khách có nhu cầu trung chuyển, vui lòng liên hệ Tổng đài trung chuyển <span className="font-bold text-orange-500">1900 6918</span> trước khi đặt vé.</p>
                  <p>(*) Vui lòng liên hệ Trung tâm tổng đài chăm sóc khách hàng <span className="font-bold text-orange-500">1900 6067</span> để được hỗ trợ 24/7.</p>
                </div>
              </div>
